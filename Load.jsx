...
function Load() {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-2xl">
      <h2 className="text-2xl font-bold mb-4">{datas.mozgasforma} jelentkezés</h2>
      ...
      <div className="grid grid-cols-1 justify-items-center m-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <Link to="/training">
            <button
              className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline items-center"
              type="button">
              Mégse
            </button>
          </Link>
